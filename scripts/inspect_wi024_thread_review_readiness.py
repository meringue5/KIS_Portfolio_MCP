#!/usr/bin/env python3
"""Print aggregate-only WI-024 runtime readiness without mutating the warehouse."""
...
def main() -> None:
    ...
    try:
        print(json.dumps(inspect_thread_review_readiness(connection), ensure_ascii=False, sort_keys=True))
    finally:
        close_connection()
