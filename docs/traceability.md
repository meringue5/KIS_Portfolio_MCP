...
| DEC-031/032 catalog and quality read model | V2-W0410 | WI-040 / WI-040-S01..S02 | WI-012, WI-019, WI-020 | S01 closed; S02 owner-decision-ready with packaged-manifest plus MotherDuck-Control DB-only authority, 6 Control dataset and 3 read-model contract proposal, typed sensitivity projection, bounded queries and unavailable>failed>partial>stale>not_assessed>pass composition; no adoption/implementation/MCP change; parent proposed |
