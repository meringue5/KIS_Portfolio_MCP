...
| DEC-002/033..041 Remote production cutover | V2-W0704/0705/0707 | WI-046 / WI-046-S01..S03 | WI-045 | in progress; live OAuth and representative reads pass; PR #88/master `918800b` promoted Remote with exact rollback, and PR #90/master `2ae1765` corrected quality semantics and logical-run polling before deploying `00039`; first Claude command reached `00039` but failed closed before claim/enqueue because the stored owner `user_id` was not projected to `AccessToken.subject`, now tracked by WI-046-S03 without weakening owner authority; auth serving revision and all six schedules remain unchanged, no retirement or cleanup |
