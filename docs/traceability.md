...
| DEC-009..014 reconstruction production impact | ADR-021/023 + V2-ADR-006/010/016 | WI-022 / WI-022-S05 | aggregate-only read-only production planner; fail-closed Silver gate | repeated hash `b0dfeb93...ba96`; 57 exceptions, 0 Silver projections, 0 writes/calls | closed |
