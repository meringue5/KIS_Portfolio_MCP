...
| DEC-026..028 replay and shadow | V2-W0509 | WI-029-S01..S06 | WI-028 | stabilizing; S06 requires terminal outcome/claim plus post-cutover completion marker, preserves the 9/3 commit failure as an explicit exception, and S05 collects corrected 9/1-9/14 evidence |
| DEC-006/026..030/050/051/053 Telegram delivery | V2-W0508 | WI-030-S01..S05 | permanent rule depends on WI-029; S02 immutable canary, S03 Rich production-value, S04 temporal acceptance, S05 repeated-session recovery | S03 owner-confirmed 14:30/16:00 Rich receipts on 2026-09-08; S05 PR #51 / recovery `l7hr5` | WI-030/S04 stabilizing |
| DEC-048/054/055 scheduled total-asset report | V2-W0510 + legacy digest v1 + owner report v2 | WI-055 / WI-055-S01 | exact same-slot valuation change, alias-only exact totals/allocation, deterministic PNG and Control-ledger idempotency | v1 receipts rejected; v2 full 502 and deploy `34336332698`, image `b54a9819...9ffd`, next receipt pending | stabilizing; owner acceptance pending |
...
| DEC-002/033..041 Remote production cutover | V2-W0704/0705/0707 | WI-046 / WI-046-S01 | WI-045 | in progress; exact least-privilege IAM, migrations through 0018, verified operational-state copy and zero-traffic auth/Remote candidates complete; Claude DCR/login/token succeeded but literal `resource=None` bound 136/138 inspected token digests and caused Remote 401; S01 repository correction is verified by 83 focused and 658 full tests, canonicalizes omitted/sentinel resource and fails closed on other/unbound targets; V1 remains 100%, Remote candidate 0%, six schedules unchanged; protected candidate and corrected live OAuth/read-command evidence remain before promotion, no retirement or cleanup |
