...
| DEC-010..014/029 Remote managed commands | V2-W0604/0605 | WI-043 | WI-024, WI-042 | in progress in isolated scope; typed command ports, fixed-job/idempotency and append-only journal/thread revision fixtures only; no OAuth grant, actual Job, live DB write, infrastructure, deployment or production effect |
