...
| --- | --- | --- | --- | --- | --- |
| 실제 Claude가 `000660`, `dataset.price-bar-daily`, `portfolio-refresh`를 조회했을 때 데이터·증거·식별자 실패가 모두 `no_governed_rows`로 보이고 후속 연결이 tagged Host 421로 실패한 문제를 교정 | existing DEC-029/031/032/034/038 and ADR-020/021/028; no scope expansion | WI-058 discovered from WI-042/WI-046; WI-058-S01 | public identifier resolver, precise unavailable reasons, direct exposure query, per-run price quality evidence, real-input regression, exact compatibility Host deployment propagation | PR #111 / `8e09c45`; V2 core Job run 34916315077; PR #113 / `80d9c9b`; Remote run 34933310119 and revision 00047; 0% tag smoke and post-promotion canonical/tag checks returned health 200 and MCP 401; no new 421/Invalid Host log | WI-058/S01 stabilizing; owner authenticated Claude read acceptance pending |
