...
| DEC-002/029 client compatibility | V2-W0606/0607 | WI-044 | WI-042, WI-043 | in progress in isolated scope; recorded client-profile protocol fixtures, exact V1-to-V2 manifest and Remote-only migration guide; actual connector/public smoke remains production-gated |
