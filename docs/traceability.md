...
| DEC-034/040 V1 resource cleanup | V2-W0804 | WI-049 / WI-049-S01/S02/S03 | WI-047 | in progress; S02 closed after master run 34781573015 deleted exactly 11 approved one-time Job definitions, post-smoke passed, all 15 protected history counts were unchanged, and 6 scheduled Jobs/6 Schedulers/2 services plus the private backup remained protected; Artifact Registry cleanup is still unapproved and isolated to S03 |
