...
| DEC-002/033..041 Remote production cutover | V2-W0704/0705/0707 | WI-046 / WI-046-S01..S04 | WI-045 | in progress; live OAuth and representative reads pass; PR #91/master `5dbf7ce` restored the owner subject and Remote `00042` passed authorization, then its command smoke failed closed at Job enqueue because the adapter requested forbidden runtime args under the intended Job-scoped invoker role; WI-046-S04 verified fixed-Job invocation, current-date-only dispatch and existing logical-run reuse without widening IAM, with 30 focused and 667 full tests; auth serving revision and all six schedules remain unchanged, no retirement or cleanup |
