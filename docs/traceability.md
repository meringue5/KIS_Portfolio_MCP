...
| --- | --- | --- | --- | --- | --- |
| owner 개인 총자산 리포트에 정확한 총액·증감액, alias 기반 구성과 차트를 제공하고 식별자·본문 로그는 숨김 | DEC-055 supersedes DEC-054 presentation/privacy boundary | WI-055-S01 | presentation v2 contract, deterministic chart attachment, terminal media-delivery ledger | 2026-09-09 owner screenshot; 10:00/16:00 Control ledger sent/pass; repository implementation pending | in_progress; production effects none |
...
| 오전 10시·오후 4시 총자산 변화와 보유종목 Top 3 영향을 Rich Message로 수신 | DEC-054 | WI-055 | exact same-slot V2 reader, privacy-safe digest renderer, terminal Control-ledger delivery, fixed-slot Job composition | focused 68/full 466; PR #55/master `1025f4a`; run `34225691712`; three Jobs digest `98bb6dc9...747e4`, flag true | stabilizing; first scheduled owner receipt pending |
...
| DEC-048/054 scheduled total-asset digest | V2-W0510 + pipeline.telegram-total-asset-digest-v1 | WI-055 | exact same-slot valuation-change result, privacy-safe Rich renderer and Control-ledger idempotency | focused 68/full 466; master `1025f4a`; run `34225691712`; digest `98bb6dc9...747e4` | stabilizing; scheduled owner receipt pending |
