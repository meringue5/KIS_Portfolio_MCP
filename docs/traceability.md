...
| --- | --- | --- | --- | --- | --- |
| 오전 10시·오후 4시 총자산 변화와 보유종목 Top 3 영향을 Rich Message로 수신 | DEC-054 | WI-055 | exact same-slot V2 reader, privacy-safe digest renderer, terminal Control-ledger delivery, fixed-slot Job composition | focused 68/full 466; PR #55/master `1025f4a`; run `34225691712`; three Jobs digest `98bb6dc9...747e4`, flag true | verified; first scheduled owner receipt pending |
| Telegram 경보를 한눈에 읽히는 Rich Message로 전환하고 반복·오해 문구를 제거 | DEC-053 | WI-030-S03 | production-value-v3 renderer, sendRichMessage adapter, Cloud Run provider-confirmed predeploy smoke, trusted-template/dynamic-field redaction split | PR #53 / master `90879150`; full 460 pass; run `34182558405`; owner confirmed 14:30/16:00 Rich receipt on 2026-09-08 | S03 closed; WI-030 verified, S04 temporal evidence remains |
...
| DEC-026..028 replay and shadow | V2-W0509 | WI-029-S01..S06 | WI-028 | verified implementation; S06 requires terminal outcome/claim plus post-cutover completion marker, preserves the 9/3 commit failure as an explicit exception, and S05 collects corrected 9/1-9/14 evidence |
| DEC-006/026..030/050/051/053 Telegram delivery | V2-W0508 | WI-030-S01..S05 | permanent rule depends on WI-029; S02 immutable canary, S03 Rich production-value, S04 temporal acceptance, S05 repeated-session recovery | S03 owner-confirmed 14:30/16:00 Rich receipts on 2026-09-08; S05 PR #51 / recovery `l7hr5` | WI-030 verified; only S04 temporal evidence remains |
| DEC-048/054 scheduled total-asset digest | V2-W0510 + pipeline.telegram-total-asset-digest-v1 | WI-055 | exact same-slot valuation-change result, privacy-safe Rich renderer and Control-ledger idempotency | focused 68/full 466; master `1025f4a`; run `34225691712`; digest `98bb6dc9...747e4` | verified; scheduled owner receipt pending |
...
| DEC-031/032 catalog and quality read model | V2-W0410 | WI-040 / WI-040-S01..S03 | WI-012, WI-019, WI-020 | S01~S03 closed; owner-approved packaged-manifest plus MotherDuck-Control DB-only authority, 6 approved Control datasets and 3 approved-inactive read models adopted with typed suppression, 256 KiB/query bounds and unavailable>failed>partial>stale>not_assessed>pass composition; 161 DGH contracts and full 443 pass; no DTO/DDL/DB/source/MCP activation; parent proposed |
