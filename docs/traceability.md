...
| DEC-034/040 V1 resource cleanup | V2-W0804 | WI-049 / WI-049-S01/S02/S03 | WI-047 | in progress; S02 closed with histories/runtime/backups protected; owner approved S03 cleanup of the merged exact 59 untagged digests, with fresh-inventory, no-tag, no-live-reference and master-only apply gates |
