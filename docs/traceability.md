...
| DEC-002/029/034 stateless Remote MCP reads | V2-W0601~0603 | WI-042 / WI-042-S01 | WI-030, WI-040, WI-041 | parent in progress in isolated scope; parallel 15-read V2 builder, typed DTO/handlers, request actor/scope and official stateless transport fixtures only; no OAuth grant, public endpoint, live DB/KIS, deployment or production effect |
