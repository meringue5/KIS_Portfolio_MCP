...
| DEC-034/040 V1 resource cleanup | V2-W0804 | WI-049 / WI-049-S01/S02/S03 | WI-047 | in progress; S01 verified exact read-only inventory, 15 protected history baselines, private restore evidence and 11 unscheduled one-time Job candidates under a no-apply manifest; S02 exact-target approval pending; Artifact Registry cleanup isolated to later S03 |
