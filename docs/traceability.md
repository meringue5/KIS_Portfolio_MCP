...
| DEC-031/032 catalog and quality read model | V2-W0410 | WI-040 / WI-040-S01..S03 | WI-012, WI-019, WI-020 | parent in progress under isolated overlap; approved inactive contracts bound implementation to typed DTOs, packaged manifests and bounded read-only Control queries; DDL/live DB/MCP activation blocked until MS-002 closes |
