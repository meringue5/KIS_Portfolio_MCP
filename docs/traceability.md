...
| --- | --- | --- | --- | --- | --- |
| owner 개인 총자산 리포트에 정확한 총액·증감액, alias 기반 구성과 차트를 제공하고 식별자·본문 로그는 숨김 | DEC-055 supersedes DEC-054 presentation/privacy boundary | WI-055-S01/S02 | presentation v2 contract, deterministic PNG/chart attachment, terminal owner-report ledger, same-image photo smoke and atomic release/rollback guard | S01 full 501; run `34335622544` safe no-op; S02 focused 39/full 502 verifies exact workflow dispatch | S01/S02 verified; production release retry pending |
...
| 오전 10시·오후 4시 총자산 변화와 보유종목 Top 3 영향을 Rich Message로 수신 | DEC-054/055 | WI-055 | exact same-slot V2 reader, legacy percentage digest plus corrected owner-only amount/chart presentation | PR #55/master `1025f4a`; 2026-09-09 10:00/16:00 sent/pass receipts rejected for information value; S01 repository correction verified | stabilizing; corrected release and owner acceptance pending |
...
| DEC-048/054/055 scheduled total-asset report | V2-W0510 + legacy digest v1 + owner report v2 | WI-055 / WI-055-S01 | exact same-slot valuation change, alias-only exact totals/allocation, deterministic PNG and Control-ledger idempotency | v1 10:00/16:00 sent/pass but owner rejected information value; S01 focused 69/full 501, production effects none | stabilizing; v2 release and owner acceptance pending |
...
| DEC-020..025 filing actual/fundamental facts | V2-W0406 | WI-037 / WI-037-S01..S03 | WI-012, WI-017 | parent proposed; S01~S03 closed; ADR-025 and 7 approved-inactive contracts adopted with additive migration 0014, dual as-of modes, DART 100/250 and SEC 64/320 caps, 5 GiB/2M stop lines and shared-implementation constraint; 123 DGH/full 438 pass, no implementation/source/activation; MS-003 gate unchanged |
| DEC-023 dividend ledger | V2-W0407 | WI-038 / WI-038-S01..S03 | WI-020, WI-021, WI-037 | parent proposed; S01~S03 closed; ADR-026 and 8 approved-inactive contract deltas adopted with action/entitlement/receipt-link split, cash SSOT, system-as-of, additive migration 0015, KIS 64/320 and 10-page caps, 1 GiB/500k stop lines, explicit IRP/U.S. receipt gaps and shared-implementation constraint; 129 DGH/full 438 pass, no implementation/source/activation; MS-003 gate unchanged |
...
| DEC-031/032 catalog and quality read model | V2-W0410 | WI-040 / WI-040-S01..S03 | WI-012, WI-019, WI-020 | S01~S03 closed; owner-approved contracts adopted; parent proposed and isolated implementation overlap approved; DDL/live DB/MCP activation blocked until MS-002 closes |
