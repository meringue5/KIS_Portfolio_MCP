...
| DEC-002/033..041 Remote production cutover | V2-W0704/0705/0707 | WI-046 / WI-046-S01 | WI-045 | in progress; exact least-privilege IAM, migrations through 0018 and verified state copy complete; PR #87/master `3352e14` corrected literal-None binding, auth `00027` is promoted with exact `00025` rollback, and canonical-name Claude reauthorization produced token 200 plus two authenticated candidate `/mcp` 200 responses; Remote `00031` remains 100% and candidate `00036` 0% pending the new exact-revision protected Remote promotion; six schedules unchanged, no retirement or cleanup |
