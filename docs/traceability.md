...
| --- | --- | --- | --- | --- | --- |
| 오전 10시·오후 4시 총자산 변화와 보유종목 Top 3 영향을 Rich Message로 수신 | DEC-054 | WI-055 | exact same-slot V2 reader, privacy-safe digest renderer, terminal Control-ledger delivery, fixed-slot Job composition | focused 68 and full 466 pass; production deploy/receipt pending | in progress |
...
| DEC-048/054 scheduled total-asset digest | V2-W0510 + pipeline.telegram-total-asset-digest-v1 | WI-055 | exact same-slot valuation-change result, privacy-safe Rich renderer and Control-ledger idempotency | focused/full and deployment evidence pending | in progress |
