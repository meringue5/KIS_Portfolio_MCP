...
| --- | --- | --- | --- | --- | --- |
| Telegram 경보를 한눈에 읽히는 Rich Message로 전환하고 반복·오해 문구를 제거 | DEC-053 | WI-030-S03 | production-value-v3 renderer, sendRichMessage adapter, successor immutable RC, pipeline/dataset contract v1.4/v1.3 | rc2 27/27 live sends 뒤 owner feedback; focused Rich Message tests and live receipt pending | S03 in progress |
