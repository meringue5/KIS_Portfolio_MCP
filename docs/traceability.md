...
| DEC-034/040 V1 resource cleanup | V2-W0804 | WI-049 / WI-049-S01/S02/S03 | WI-047 | in progress; S02 closed after exact 11-Job cleanup with all histories/runtime/backups protected; S03 is active only to freeze an exact-digest retain/delete specification, while Artifact Registry mutation remains unapproved |
