...
| --- | --- | --- | --- | --- | --- |
| 실제 Claude가 `000660`, `dataset.price-bar-daily`, `portfolio-refresh`를 조회했을 때 데이터·증거·식별자 실패가 모두 `no_governed_rows`로 보이고 후속 연결이 tagged Host 421로 실패한 문제를 교정 | existing DEC-029/031/032/034/038 and ADR-020/021/028; no scope expansion | WI-058 discovered from WI-042/WI-046; WI-058-S01/S02 | public identifier resolver, precise unavailable reasons, direct exposure query, per-run price quality evidence, real-input regression, exact compatibility Host deployment propagation, public price-bar dataset alias | PR #111 / `8e09c45`; V2 core Job run 34916315077; PR #113 / `80d9c9b`; Remote 00047 owner-confirmed; PR #115 / `13c0ce5`; Remote run 34959901112 and revision 00048; owner Claude read returned two passing 34/34 price-quality rows; Cloud Run execution metadata proved the missing 10:00 row used pre-release SHA `e458ba5` while 14:30/16:00 used `8e09c45`; canonical/tag transport 200/401 | closed; S01/S02 owner-confirmed |
...
| owner 개인 총자산 리포트에 정확한 총액·증감액, alias 구성과 절대 영향 Top 5 차트를 제공하고 식별자·본문 로그는 숨김 | DEC-055 supersedes DEC-054 presentation/privacy boundary | WI-055-S01/S02/S03/S04 | presentation 2.2.0, deterministic allocation/diverging-impact PNG, structured fixed-width caption, terminal owner-report ledger and same-image release guard | S04 PR #68/master `c1481b6`, protected deploy `34466281709`; 9/11 10:00 quality pass/provider sent; owner accepted shortened window | closed; continued rendering monitored in MS-003 stabilization |
...
| 오전 10시·오후 4시 총자산 변화와 보유종목 절대 영향 Top 5를 owner-only photo report로 수신 | DEC-054/055 | WI-055 | exact same-slot V2 reader, exact amount/allocation caption and deterministic Top 5 impact chart | S03 content accepted; S04 protected release and 9/11 10:00 pass/sent verified; owner ended further observation | closed; 9/11 16:00 S04 rendering not separately claimed |
| Telegram 경보를 한눈에 읽히는 Rich Message로 전환하고 반복·오해 문구를 제거 | DEC-053 | WI-030-S03/S04 | production-value-v3 renderer, sendRichMessage adapter, Cloud Run provider-confirmed predeploy smoke, trusted-template/dynamic-field redaction split | PR #53 / master `90879150`; full 460 pass; run `34182558405`; owner confirmed 14:30/16:00 Rich receipt on 2026-09-08 | S03 closed; WI-030/S04 stabilizing |
| 첫 실사용 경보의 이동평균 상태/교차, 초기 baseline, 장중 거래량과 품질 문구를 정확히 하고 장기 window 인수를 분리 | DEC-052 | WI-030-S03/S04 | stabilized immutable RC, precise public context/renderer, calendar-window acceptance plan | correction deployed and initial Rich receipts confirmed; longer calendar windows remain | S03 closed; S04 stabilizing |
| MS-002는 production-equivalent Telegram 메시지의 실사용·안정화·owner acceptance 뒤에만 완료 | ADR-021/023 + DEC-051 | WI-054, WI-029, WI-030, WI-055 | production-readiness matrix, corrected shadow, production-value Telegram and owner report | 9/10 31/31 corrected evidence; 9/11 10:00/14:30 successful, 14:30 owner receipt; explicit early-close risk acceptance | closed; unobserved 9/14 and Friday U.S. close carried into MS-003 stabilization |
| 첫 정상 월요일 뒤 Telegram `주의` 이상 신호를 1주 experimental canary로 관찰 | ADR-021/023 + V2-ADR-007/012 + DEC-050 | WI-030-S01/S02 | fail-closed renderer/ledger plus parallel immutable canary rule; permanent WI-029 gate remains | 18/18 provider-confirmed sends, owner receipt and expiry/revocation evidence | S01/S02 closed; immutable history retained |
...
| DEC-026..028 replay and shadow | V2-W0509 | WI-029-S01..S06 | WI-028 | closed by explicit owner acceptance at the 2026-09-11 14:30 boundary; 31/31 corrected due slots and the preserved 9/3 exception remain immutable evidence |
| DEC-006/026..030/050/051/053 Telegram delivery | V2-W0508 | WI-030-S01..S05 | permanent rule depends on WI-029; S02 immutable canary, S03 Rich production-value, S04 temporal acceptance, S05 repeated-session recovery | S03 owner-confirmed 14:30/16:00 Rich receipts on 2026-09-08; S05 PR #51 / recovery `l7hr5`; 2026-09-11 14:30 receipt accepted | closed; deliberately shortened observation period recorded |
| DEC-048/054/055 scheduled total-asset report | V2-W0510 + legacy digest v1 + owner report v2 | WI-055 / WI-055-S01 | exact same-slot valuation change, alias-only exact totals/allocation, deterministic PNG and Control-ledger idempotency | S04 PR #68/master `c1481b6`, deploy `34466281709`; 2026-09-11 10:00 pass/sent and owner acceptance | closed; no separate 9/11 16:00 rendering claim |
| DEC-033..041 production cost/release controls | V2-W0002/0003/0106 | WI-035 / WI-035-S01 | WI-012 | verified with side-effect-free v1 inventory/release validators, deterministic cost evaluator and fail-closed cleanup dry-run planner; 18 focused/full 493 pass; synthetic fixtures only; fresh production inventory/manifest, cleanup apply and all production effects blocked until MS-002 closes |
| DEC-020..025 filing actual/fundamental facts | V2-W0406 | WI-037 / WI-037-S01..S03 | WI-012, WI-017 | parent verified in isolated scope; additive 0014, exact alias/private-object gate, immutable filing/fact revisions, dual as-of, query-time mapping, budget/quality watermark and fresh restore; 15 focused + 532 full passed; contracts approved-inactive, no source/live DB/schedule/public effect |
| DEC-023 dividend ledger | ADR-026 / V2-W0407 | WI-038 / WI-038-S01..S03 | WI-020, WI-021, WI-037 | parent verified in isolated scope; additive 0015, 7 tables + 5 views, immutable action/entitlement/reversible receipt-link revisions, cash monetary SSOT, system-as-of monthly native/FX read models, budget/capacity/quality gates and fresh restore; 10 focused + 33 integration + 539 full passed; contracts inactive and production effects none |
| DEC-022/024/026 macro profile | V2-W0408 | WI-039 / WI-039-S01..S04 | WI-012 | parent verified in isolated scope; exact 17-series registry, additive 0016, provider-vintage/observed-content PIT revisions, five metrics, budget/capacity/quality guards and fresh restore; contracts inactive, production effects none |
| DEC-031/032 catalog and quality read model | V2-W0410 | WI-040 / WI-040-S01..S03 | WI-012, WI-019, WI-020 | verified with immutable DTO/policy envelope, six-kind packaged catalog, bounded parameterized Control projections, sensitivity/opaque-ref filtering and false-green status composition; 12 focused/full 518 pass; synthetic local evidence only, no DDL/live DB/public MCP/production effect; contracts remain inactive |
| DEC-021/022/032/041/043 forward consensus | V2-W0506 | WI-041 / WI-041-S01..S04 | WI-037 | parent verified in isolated scope; exact inactive Alpha bundle, additive 0017, raw-free normalized snapshots, fetched-at revisions, scenario/coverage/rights/cost guards and fresh restore; historical PIT and production effects remain prohibited |
| DEC-002/029/034 stateless Remote MCP reads | V2-W0601~0603 | WI-042 / WI-042-S01 | WI-030, WI-040, WI-041 | parent verified in isolated scope; exact inactive 15-read catalog, complete typed query port/envelope, actor scope/resource and sensitive-field enforcement, official stateless JSON plus local replica-equivalent fixtures; focused 19, integration 136, full 575 passed; V1 remains 35 tools; no OAuth grant/public endpoint/live DB/KIS/deployment/production effect |
| DEC-010..014/029 Remote managed commands | V2-W0604/0605 | WI-043 | WI-024, WI-042 | verified in isolated scope; exact inactive 18-tool catalog, fixed portfolio-refresh mapping and immediate run ID, split collect/journal auth, owner subject, fenced idempotency/concurrency and append-only revision fixtures; focused 34/full 590 passed; no OAuth grant, actual Job, live DB/KIS, infrastructure, public activation, deployment or production effect |
| DEC-002/029 client compatibility | V2-W0606/0607 | WI-044 | WI-042, WI-043 | verified for isolated phase; three recorded client profiles pass fresh stateless 18-tool transport and representative calls, exact 35-to-18 manifest covers 33 migrations + 2 order unsupported, Remote-only guide and explicit scope consent; focused 7/adjacent 77/full 597 passed; live Claude/ChatGPT/iPhone evidence remains WI-046 gate, no production effect |
...
| DEC-047 final V2 documentation SSOT | V2-W0807 | WI-032 | WI-051 | closed; 99 V1-era Markdown documents classified as 22 canonical, 76 retained history and one redirect; zero deletion candidates; canonical links pass; full 719 passed; no production effect |
