...
| 현재 단일 WIP | MS-004 `WI-049` in progress; S01 no-apply readiness verified, S02 exact Job approval pending |
| 파괴적 변경 gate | S02 Job 11개와 S03 image digest는 서로 별도 승인; Secret·data·backup·active V2 삭제는 금지 |
