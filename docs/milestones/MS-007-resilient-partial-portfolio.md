...
| 2026-09-23.3 | 2026-09-23 | Run `35806435798` created a labeled new revision/digest but historical manual traffic remained pinned to the old revision | Add explicit `--to-latest`; require ready and 100% traffic evidence before owner login |
| 2026-09-23.4 | 2026-09-23 | Run `35807135080` proved `gcloud run deploy` rejects `--to-latest` before mutation | Move traffic in a separate supported `services update-traffic --to-latest` step after successful deploy |
| 2026-09-23.5 | 2026-09-23 | Run `35807966171` served the corrected auth revision; real Codex DCR then requested public-client authentication | Admit `none` only for validated IPv4 loopback callbacks and retain PKCE plus owner login gates |
| 2026-09-23.6 | 2026-09-23 | Authenticated Codex overview reached Remote and exposed mixed MotherDuck date representations in FX quality comparison | Normalize date-like values at the shared quality boundary and require an immediate direct-call replay |
| 2026-09-23.7 | 2026-09-23 | PR #131/run `35810401697` served the date normalization and an immediate authenticated Codex overview returned a passing 32-row total | Close WI-060-S03; keep MS-007/WI-060 stabilizing only for owner-visible scheduled report acceptance |
| 2026-09-23.8 | 2026-09-23 | Immediate Codex negative tests proved stable server codes are collapsed into generic SDK errors | Append WI-060-S04; expose redacted owner-debug errors now and defer a restrictive external profile until public multi-user conversion |
| 2026-09-23.9 | 2026-09-23 | PR #133 and Remote run `35838679947` deployed owner-debug errors; direct Codex negative replay exposed all three expected codes and request IDs | Close WI-060-S04; keep MS-007/WI-060 stabilizing only for owner-visible scheduled report acceptance |
