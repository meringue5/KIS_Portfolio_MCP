...
- Parquet: `bronze.source_observations`, `silver.accounts`, `silver.instruments`, `silver.instrument_versions`,
  ...
  `silver.trade_journal_revisions`, `silver.trade_thread_command_revisions`,
  ...
  `silver.dividend_events`, `silver.dividend_actions`, `silver.dividend_action_revisions`,
...
- Rebuild/excluded: `silver.instrument_versions_effective`, `silver.instruments_current`,
  ...
  `silver.macro_observations_as_of`, `silver.alpha_vantage_consensus_forward_latest`,
  `gold.dividend_monthly_native`,
